    ...
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b bg-background px-4 md:px-6">
      <div className="flex items-center gap-2">
        <div className="h-8 w-8">
          ...
          <div className="flex h-8 w-8 items-center justify-center rounded-md bg-brand-primary text-white text-xs font-bold">
            SC
          </div>
        </div>
        <h1 className="text-xl font-bold">Feedback Insights</h1>
      </div>
      ...
      <div className="flex items-center gap-4">
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            <DropdownMenuItem>Feedback Insights</DropdownMenuItem>
